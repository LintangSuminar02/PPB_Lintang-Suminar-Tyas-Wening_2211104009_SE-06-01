  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: const Color.fromARGB(255, 167, 255, 240),
      ),
      body: Padding(
              ...
              children: [
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color.fromARGB(255, 255, 170, 168),
                  ),
                ),
                ElevatedButton.icon(
                  onPressed: () async {
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color.fromARGB(255, 255, 170, 168),
                  ),
                ),
              ],
            ),
